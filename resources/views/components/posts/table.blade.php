@if (Session::has('success'))
    <div class="flex justify-center">
        <div id="toast-success"
            class=" absolute top-40 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800"
            role="alert">
            <div
...
<section class="p-3 sm:p-5 antialiased">
    <h2 class="pl-4 py-4 text-xl font-semibold">Post by: {{ Auth::user()->name }}</h2>
    <div class="max-w-screen-xl px-4">
        <div class="bg-white dark:bg-gray-800 relative border sm:rounded-lg overflow-hidden">
            ...
            {{-- jika pagination memiliki halaman maka pagination akan tampil sebalik jika tidak --}}
            @if ($posts->hasPages())
                <div class="p-3">
                    {{ $posts->links() }}
                </div>
